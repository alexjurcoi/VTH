...
if do_dynamic_ghad:
    ...
    for mechanism_choice in mechanisms_to_run:
        ...
        space = [
            Real(-0.10, 0.30, name='dGmin_eV'),
            Real(-0.10, 0.30, name='dGspan_eV'),
            ]
        ...
        for f in sorted(all_evals_by_freq.keys()):
            ...
            sc = plt.scatter(x_dGmin, y_dGmax, c=z_met, s=80, norm=norm)
        ...
        for f in sorted(all_evals_by_freqV.keys()):
            ...
            plt.figure(figsize=(10, 8))
            sc = plt.scatter(x_dGmin, y_dGmax, c=z_met, s=80, norm=normV)
            plt.colorbar(sc, label="mean(|rV|) (mol/cm²·s)")
