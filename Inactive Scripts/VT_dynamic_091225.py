...
k_V_RDS = 6.590103e-05 / 5000 #units of mol/cm^2
...
if do_dynamic_ghad:
    ...
    for freq in freq_array:
        ...
        avg_curr_at_dGmin=np.abs(np.average(curr_dynamic[mask_min]))
        avg_curr_at_dGmax=np.abs(np.average(curr_dynamic[mask_max]))
