...
partialPH2 = 1.0
beta = [0.35, 0.5]
freq_array = [1, 10, 100, 1000, 10000, 100000, 1e6, 1e7]
...
if do_dynamic_ghad:
    ...
    fig.suptitle(f"Dynamic GHad(t): Current vs Time, Step Factor = {maxstep_factor}", fontsize=16)
