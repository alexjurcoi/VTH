...
if do_dynamic_ghad:
    ...
    for mechanism_choice in mechanisms_to_run:
        ...
        space = [
            Real(-0.30, 0.30, name='dGmin_eV'),
            Real(-0.30, 0.30, name='dGspan_eV'),
            ]
        ...
        if best_by_freq:
            ...
            plt.title(f"Best binding energies vs frequency (rT/rH metric) ({mech_label})")
            plt.grid(True)
            plt.legend()
            plt.tight_layout()
            plt.show()
            ...
            plt.xscale("log")
            plt.xlabel("Frequency (Hz)")
            plt.ylabel("Best metric (mean rT or mean rH)")
            plt.title(f"Best rT/rH metric vs frequency ({mech_label})")
            plt.grid(True)
            plt.tight_layout()
            plt.show()
