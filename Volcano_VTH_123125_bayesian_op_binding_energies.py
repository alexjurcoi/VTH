...
if do_dynamic_ghad:
    ...
    for mechanism_choice in mechanisms_to_run:
        ...
        space = [
            Real(-0.10, 0.08, name='dGmin_eV'),
            Real(0.14, 0.38, name='dGspan_eV'),
            ]
        ...
        for freq in freq_array:
            ...
            def objective_bounds(x):
                ...
                eval_rows.append({
                    ...
                    "span_eV": dGspan_eV,
                    "metric_mean_abs_rV": float(metric),
                })
        ...
        for freq in freq_array:
            ...
            def objective_boundsV(x):
                ...
                eval_rowsV.append({
                    ...
                    "dGmax_eV": dGmax_eV_cand,
                    "span_eV": dGspan_eV,
                    "metric_mean_abs_rV": float(metricV),
                })
            ...
            res = gp_minimize(
                ...
                n_calls=11, n_initial_points=10,
        ...
        for f in sorted(all_evals_by_freqV.keys()):
            ...
            z_met   = np.array([r["metric_mean_abs_rV"] for r in rows])
        
            plt.figure(figsize=(10, 8))
            sc = plt.scatter(x_dGmin, y_dGmax, c=z_met, s=80)  # no explicit colors set
